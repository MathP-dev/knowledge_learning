 ...
 *     mcp?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         format?: scalar|null|Param, // The serialization format used for MCP tool input/output. Must be a format registered in api_platform.formats (e.g. "jsonld", "json", "jsonapi"). // Default: "jsonld"
 *     },
